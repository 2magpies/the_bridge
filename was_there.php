...
<div id="wrapper">
 ...
 echo date("T") . "<br>"; ?> </h5>
	...
	<div id="content-wrapper">
		...
		<p>Number of people reporting they attended this event:<b> <?php require 'includes/constant/was_there_counter.php';?></b></p>
		...
		<p> 
			...
			require  'includes/constant/was_there_counter_insert.php';?>
		</p>
