<?php
			...
			$q = "UPDATE kdarko_dmintz_events SET was_there = was_there + 1 WHERE month(kdarko_dmintz_events.day) = month(now()) and day(kdarko_dmintz_events.day) = day(now()) and post_state = 'in_the_box';";
